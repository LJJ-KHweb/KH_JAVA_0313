...
public class Run {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// domain name : 사용자가 서비스를 이용할 때 서버의 IP주소를 외우기 어려우니까 외우기 쉬운 구조로 사용자에게 제공하는 이름
			 ...
			 * 웹 통신 방식 : HTTPS(Hyper Test Transfer Protocol Secure)
...
//				즉, Client 요청에 대한 응답을 제공해주는 서비스 제공자
//	- Client : Sever 에게 서비스를 요청하는 물리적인 컴퓨터 또는 프로그램
//				즉, 서비스를 제공 받는 고객
//	-> 서버는 자기 혼자 응답을 보낼 수 없음!! 클라이언트의 요청이 들어와야만 응답을 보내줄 수 있음
//	-> 클라이언트는 서버에 요청을 보내기 위해서 서버의 IP주소와 Port 번호를 알아야 함
